...
public class EgovMComIndexController implements ApplicationContextAware ,InitializingBean {
	...
	protected static final Log LOG = LogFactory.getLog(EgovMComIndexController.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext)
		...
		LOG.info("EgovMComIndexController setApplicationContext method has called!");
	}
	...
	public String mobileMenu(ModelMap model){
		...
		if(map == null){
			...
			try{
				...
				LOG.error("No egovframework.mbl.com.uat.uia.web.EgovMblLoginController!!");
			}
		...
		LOG.debug("EgovMComIndexController index is called " );
